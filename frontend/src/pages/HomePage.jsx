...
const stack = ['Python','FastAPI','JavaScript','yfinance','scikit-learn','pandas','NumPy','Docker','Docker Compose','REST API','NLP / Sentiment','CSS3'];
...
export default function HomePage({ setPage }) {
  const goAnalysis = () => { setPage('analysis'); window.scrollTo({ top: 0, behavior: 'smooth' }); };
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-btns">
            ...
            <button className="btn-ghost" onClick={() => document.getElementById('features').scrollIntoView({ behavior: 'smooth' })}>Learn More</button>
          </div>
        </div>
        ...
        <div className="hero-visual">
          ...
          <div className="chart-card">
            ...
            <svg viewBox="0 0 300 80" preserveAspectRatio="none" className="sparkline">
              <defs>
